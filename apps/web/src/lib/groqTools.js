...
export function getToolsForMode(mode = 'private') {
    return mode === 'public' ? publicTools : adminTools;
}
// ============================================
// TOOL IMPLEMENTATIONS
// ============================================
export async function getStats(metric) {
...
export async function triggerAutomation(action, payload) {
...
export async function bookAppointmentWithConfirmation(name, email, phone, date, time, reason) {
 ...
 */
export async function testToolExecution(toolName, args) {
    try {
        switch (toolName) {
            case 'get_stats': {
    ...
    try {
        switch (name) {
            ...
            case 'book_appointment_with_confirmation':
                const booking = await bookAppointmentWithConfirmation(parsedArgs.name, parsedArgs.email, parsedArgs.phone, parsedArgs.date, parsedArgs.time, parsedArgs.reason);
...
// ============================================
export async function chatWithTools(messages, onToolCall, // Return true to proceed, false to cancel
toolsToUse = adminTools, // Tools to make available
