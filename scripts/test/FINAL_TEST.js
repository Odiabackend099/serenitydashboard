...
if (!supabaseServiceKey) {
  ...
  console.error('Usage: SUPABASE_SERVICE_ROLE_KEY=your_service_role_key node FINAL_TEST.js');
  process.exit(1);
}
...
async function sendTestEmail() {
  ...
  const res = await fetch('https://cwai97.app.n8n.cloud/webhook/serenity-webhook-v2', {
    method: 'POST',
