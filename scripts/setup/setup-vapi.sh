...
# Check if VAPI_PRIVATE_KEY is provided
if [ -z "$VAPI_PRIVATE_KEY" ]; then
    echo "⚠️  Please provide your VAPI Private Key"
    echo ""
    echo "Get it from: https://dashboard.vapi.ai/account"
    echo ""
    echo "Usage:"
    echo "  VAPI_PRIVATE_KEY=your_key_here ./setup-vapi.sh"
    echo ""
    exit 1
fi
...
ANON_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlmcnB4cXZqc2h3YWFvbWdjYW9xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjIyODI5MzcsImV4cCI6MjA3Nzg1ODkzN30.Y_YcL75ZIWKsb2SIfa1OKPXC3FN4kGiWrDfASYjkJ1Y"
