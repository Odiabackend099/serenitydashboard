...
Before running the sync command, make sure you have your Supabase service role key configured:

```bash
export SUPABASE_SERVICE_ROLE_KEY=your_service_role_key_here
```

**Note**: You can find your service role key in your Supabase project settings under Project Settings > API > Project API Keys.
